...
function trigramCheck(stringToCheck) {
    let score = 0;
    let i = 0;
    while (i <= stringToCheck.length - 3) {
        let sub = stringToCheck.substring(i, i + 3);
...
function CryptoAnalysisVigenere(cipherTextFull, maxLenOfKey = 0){
	...
	document.getElementById("key").innerHTML = "The key is: " + actualKey;
	document.getElementById("plaintext").innerHTML = "The plaintext is: " + allPossiblePlainTexts[bestKey][1];

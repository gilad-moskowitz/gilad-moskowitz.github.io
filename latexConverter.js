           ...
           // all variations of spaces with \begin{eqnarray*} .. \end{eqnarray*}
            ...
            for(var i=0;i<str.length;i++) {
               if(i % 2) { 
                  ...
                  str[i] = str[i].replace(/\\begin\s*\{\s*defn\s*\}/g," \\[definition\\]Definition \\[ "); 
                  str[i] = str[i].replace(/\\end\s*\{\s*defn\s*\}/g," \\[enddefinition\\] \\[ ");
           
                  str[i] = str[i].replace(/\\begin\s*\{\s*lemma\s*\}/g," \\[lemma\\]Lemma \\[ "); 
                  str[i] = str[i].replace(/\\end\s*\{\s*lemma\s*\}/g," \\[endlemma\\] \\[ ");

                  str[i] = str[i].replace(/\\begin\s*\{\s*cor\s*\}/g," \\[corollary\\]Corollary \\[ "); 
                  str[i] = str[i].replace(/\\end\s*\{\s*cor\s*\}/g," \\[endcorollary\\] \\[ ");
          
                  str[i] = str[i].replace(/\\begin\s*\{\s*prop\s*\}/g," \\[proposition\\]Proposition \\[ "); 
                  str[i] = str[i].replace(/\\end\s*\{\s*prop\s*\}/g," \\[endproposition\\] \\[ ");
